...
* @{
*/
#define PRODUCT_KEY "74f0ac5a9ebb407db8708db5a64a"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "9922505efa0c454f87163dc3bf010"
...
#define Humidity_MAX                           99
#define Humidity_LEN                           1
#define Smog_RATIO                         1
#define Smog_ADDITION                      0
#define Smog_MIN                           0
#define Smog_MAX                           331
#define Smog_LEN                           2
#define PM25_RATIO                         1
...
typedef struct {
    uint8_t flagModel:1;
    uint8_t flagFan:1;
    uint8_t flagHumidifier:1;
    uint8_t flagWindow:1;
